...
namespace Rivet {
  ...
  //=================================  Constructer ==================================//
  //=================================================================================//
  class dch_lep_rad : public Analysis {
    ...
    public:
      ...
      /// Constructor
      dch_lep_rad() : Analysis("dch_lep_rad") {   }
      ...
      std::vector<double> b_ssl_inv_mass;
      ...
      void init() {
        ...
        m_OutputTree->Branch("ssl_inv_mass", &b_ssl_inv_mass, "b_ssl_inv_mass");
      ...
      std::sort(b_ssl_inv_mass.begin(), b_ssl_inv_mass.end());
  ...
  DECLARE_RIVET_PLUGIN(dch_lep_rad);
